...
public class MainActivityViewModel extends ViewModel {
    ...
    private final MutableLiveData<Boolean> mIsServiceDiscover = new MutableLiveData<>();
    ...
    public LiveData<Boolean> getIsServiceDiscover() {
        return mIsServiceDiscover;
    }
...
//
    public void setIsConnected(String text){

       if( text==ACTION_GATT_CONNECTED){
           mIsConnected.postValue(true);
       }
      if(text==ACTION_GATT_DISCONNECTED){
          mIsConnected.postValue(false);
      }
    ...
    public void setIsServiceDiscover(int text){

        if( text==0){
            mIsServiceDiscover.postValue(true);
        }
